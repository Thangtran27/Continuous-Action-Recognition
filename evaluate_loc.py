...
class VideoInferDataset(Dataset):
    def __init__(self, video_csv_path, clip_len=16, frame_sample_rate=4, clip_stride=30, short_side_size=224, new_height=224, new_width=224, keep_aspect_ratio=True, crop=False, view="dash"):
        ...
        # for data_path in ['/home/vnpt/THANGTV/models/checkpoints/aicity_release/data/A1/s2_Alex/s2_Alex_1.mp4']:
...
def main(args, ds_init):
    ...
    start = time.time()
    dataset = VideoInferDataset(args.csv_file, frame_sample_rate=args.sampling_rate, clip_stride=args.clip_stride, crop=args.crop, view=args.view)
    ...
    with open(os.path.join(args.output_dir, "cobot_vmae_16x4.pkl"), "wb") as f:
