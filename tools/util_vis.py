...
categories = ['No gesture','Start', 'Stop', 'Slower', 'Faster', 'Done', 'FollowMe', 'Lift', 'Home', 'Interaction', \
...
def confusion_matrix(y_true= None, y_pred = None, categories = categories, save_path = None):
